 ...
 */
public class MyGridVeiwAdapter extends BaseAdapter {
	private List<MoreBean> lists;
	private BaseActivity act;

	public MyGridVeiwAdapter(List<MoreBean> lists) {
		super();
		this.lists = lists;
	...
	public View getView(int position, View v, ViewGroup parent) {
		ViewHolder vh;
		if (v == null) {
			v = act.getLayoutInflater().inflate(R.layout.fragment_more_item,
					null);
			vh = new ViewHolder();
			vh.more_iv = (ImageView) v.findViewById(R.id.fragment_more_item_iv);
			vh.more_tv = (TextView) v.findViewById(R.id.fragment_more_item_tv);
			v.setTag(vh);
		}
